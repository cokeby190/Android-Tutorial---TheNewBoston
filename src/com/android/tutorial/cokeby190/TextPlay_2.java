...
public class TextPlay_2 extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		check_command.setOnClickListener(this);
	}
	...
	public void onClick(View view) {
		...
		case R.id.button_results:
			...
			if (check.equals("left")) {
				...
				display.setTextColor(Color.rgb(movable.nextInt(265),
						movable.nextInt(265), movable.nextInt(265)));
				display.setBackgroundColor(Color.rgb(movable.nextInt(265),
						movable.nextInt(265), movable.nextInt(265)));

				// nextInt(number) --> number gives us how many numbers we want
				// to random.
